...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tab__WEBPACK_IMPORTED_MODULE_2__["default"])('.tab__headers', '.tab__item__header', '.tab__item__content', 'show');
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])('.footer__item__header');
  /*
  // SearchForm
  ...
  // Accordion
  let acc = document.getElementsByClassName('footer__item__header');
  
  for (let i = 0; i < acc.length; i++) {
  acc[i].addEventListener('click', function() {
    this.classList.toggle('footer__active');
  ...
  // Tab
  let tab = document.querySelectorAll('.tab__item__header');
  let headers = document.querySelector('.tab__headers');
  let content = document.querySelectorAll('.tab__item__content');
  function hideTabContent(a) {
  for (let i = a; i < content.length; i++) {
  content[i].classList.remove('show');
  content[i].classList.add('hide');
  tab[i].classList.remove('tab__item__header_active');
  }
  } 
  hideTabContent(1);
  ...
  tab[b].classList.add('tab__item__header_active');
  }
  } 
  ...
  // Modal (Contact)
  let contact = document.querySelector('.language__contact'),
        overlayServices = document.querySelector('#myModal'),
...
var modal = function modal() {
  function bindModal(btnTrigger, modalTrigger, closeTrigger) {
    var btn = document.querySelectorAll(btnTrigger),
